...
## 🎾 Mathematical Foundations: The Secret Math Hiding Inside Every Tennis Match
...
And there's a catch at every level: you can't just be ahead, you have to be ahead *by two*. Get to 40-40 (called deuce) and the game doesn't end until someone pulls two points clear. The same "win by two" rule shows up again at the set level with games.
...
Once you can calculate the odds at any score, something else falls out of the math almost for free: you can tell exactly *how much a single point matters*.
