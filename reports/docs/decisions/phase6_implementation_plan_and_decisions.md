...
The project's own stack conventions already flag the observability dashboard as "TBD (local/Grafana), decided at Phase 6" — not a gap I'm inferring, a decision the project already committed to making here. → **D-13**.
